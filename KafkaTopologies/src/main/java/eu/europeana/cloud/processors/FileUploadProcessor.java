 ...
 */
public class FileUploadProcessor implements Processor<String, NormalizationResult, String, NormalizationResult> {
    ...
    public void process(Record<String, NormalizationResult> processedRecord) {
        LOGGER.info("Uploading file for {}", processedRecord.value());
